...
class RoundedImageView : AppCompatImageView {
    ...
    constructor(context: Context, attrs: AttributeSet) : super(context, attrs) {
        val cornerRadius = context.resources.getDimensionPixelSize(R.dimen.padding_small)
        val roundedCorners = ALL_ROUNDED_CORNERS_VALUE
        reverseMask = false
        init()
    ...
    constructor(context: Context, attrs: AttributeSet, defStyleAttr: Int) : super(context, attrs, defStyleAttr) {
        val cornerRadius = context.resources.getDimensionPixelSize(R.dimen.padding_medium)
        val roundedCorners = ALL_ROUNDED_CORNERS_VALUE
        reverseMask = false
        init()
        setCornerRadiusInternal(cornerRadius)
